...
public class SignupServlet extends HttpServlet {
    protected void service(HttpServletRequest request, HttpServletResponse response) {
        String username, password, tel, email, headerName = "default.jpg";
        char sex;
        ...
        if (isMultipart) {
            ...
            try {
                ...
                //params正常，插入数据库
                User.addOneUser(username, password, tel, email, sex, "/img/header/" + headerName);
